...
int main()
{
    ...
    lightingShader = new Shader("4.2.lighting_maps.vs", "4.2.lighting_maps.fs");
    lampShader = new Shader("4.2.lamp.vs", "4.2.lamp.fs");
...
GLFWwindow *glAllInit()
{
    ...
    window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Specular Map", NULL, NULL);
    if (window == NULL) {

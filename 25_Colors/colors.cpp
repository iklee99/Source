// 25_Colors: showing colored cube by illumination and a lamp
...
int main()
{
    ...
    lampShader = new Shader("global.vs", "lamp.fs");
    ...
    globalShader->setVec3("objectColor", 1.0f, 0.5f, 0.31f);
    globalShader->setVec3("lightColor", 1.0f, 1.0f, 1.0f); 
    lampShader->use();
...
GLFWwindow *glAllInit()
{
    ...
    window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Colors", NULL, NULL);
    if (window == NULL) {
